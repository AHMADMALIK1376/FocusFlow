...
2. Run `git diff` via bash to see the actual changes.
...
4. Write a verdict to `.pipeline/review.md` formatted as: `VERDICT: SHIP / NEEDS WORK / BLOCK`.

For NEEDS WORK or BLOCK, list exactly what to fix and where. Be the last line of defense. Green tests are not the same as correct behavior.