...
// Small solid-red circular icon button — white refresh icon spins on hover. Used to restart a session.
export function RepeatButton({ onClick, className = '' }) {
  return (
    <button type="button" onClick={onClick} aria-label="Repeat" className={cx('ff-repeat-btn', className)}>
      <svg xmlns="http://www.w3.org/2000/svg" width="18" viewBox="0 0 20 20" height="18" fill="none" className="ff-repeat-icon">
